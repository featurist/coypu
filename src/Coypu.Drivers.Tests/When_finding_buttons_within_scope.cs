...
namespace Coypu.Drivers.Tests
{
    public class When_finding_buttons_within_scope : DriverSpecs
    {
        ...
        {
            scope1 = new DriverScope(Configuration.Default(), new IdFinder(Driver, "scope1", Root), Driver,null,null,null);
            scope2 = new DriverScope(Configuration.Default(), new IdFinder(Driver, "scope2", Root), Driver,null,null,null);
        }
