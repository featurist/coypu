...
//            LoadSpecsFor(typeof(SeleniumWebDriver), typeof(When_finding_sections_as_divs), Browser.InternetExplorer);
//            LoadSpecsFor(typeof(SeleniumWebDriver), typeof(When_finding_sections_as_divs), Browser.Chrome);
//            LoadSpecsFor(typeof(WatiNDriver), typeof(When_finding_sections_as_divs), Browser.InternetExplorer);
        }
