...
namespace Coypu.Drivers.Tests
{
    internal class When_using_iframes_as_scope : DriverSpecs
    {
        ...
        {
            var iframeOne = new DriverScope(Configuration.Default(), new IFrameFinder(Driver, "I am iframe one", Root), Driver,null,null,null);
            var iframeTwo = new DriverScope(Configuration.Default(), new IFrameFinder(Driver, "I am iframe two", Root), Driver,null,null,null);
        ...
        {
            var body = new DriverScope(Configuration.Default(), new CssFinder(Driver, "body", Root), Driver, null, null, null);
            var iframeOne = new DriverScope(Configuration.Default(), new IFrameFinder(Driver, "I am iframe one", body), Driver, null, null, null);
        ...
        {
            var iframeOne = new DriverScope(Configuration.Default(), new IFrameFinder(Driver, "I am iframe one", Root), Driver, null, null, null);
            var iframeForm = new DriverScope(Configuration.Default(), new CssFinder(Driver, "form", iframeOne), Driver, null, null, null);
